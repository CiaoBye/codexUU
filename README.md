...
当前预览版本：`0.1.08`。版本从 `0.0.1` 起步，每段累计 10 轮后进一位：`0.0.10` 的下一版为 `0.1.01`，`0.1.10` 的下一版为 `0.2.01`。每完成一轮可验收的代码更新都必须同步更新 `VERSION`、README、`AGENTS.md` 和 `agents/changelog.md`。
...
- 桌面状态悬浮窗：默认显示当前 Runtime 的可验证额度状态；支持圆环、光晕双环、极简圆形三种样式，可拖动，双击打开主窗口，并在设置或托盘菜单中开关。
